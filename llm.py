...
msg = "Provide a comma-separated list of the 10 best possible answers to the given question. (EG. The Washington Post,The New York Times,...). Your list must contain exactly 10 answers.\n" \
...
"Ensure that you do not include more than one of the same answer at any point in your list.\n" \
